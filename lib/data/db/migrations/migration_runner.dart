...
class MigrationRunner {
  static Future<void> apply(Database db, int oldVersion, int newVersion) async {
    ...
    await Migration047.apply(db, oldVersion, newVersion);
    await Migration048.apply(db, oldVersion, newVersion);
    await Migration049.apply(db, oldVersion, newVersion);
    await Migration050.apply(db, oldVersion, newVersion);
    await Migration051.apply(db, oldVersion, newVersion);
    await Migration052.apply(db, oldVersion, newVersion);
    await Migration053.apply(db, oldVersion, newVersion);
    await Migration054.apply(db, oldVersion, newVersion);
  }
}
