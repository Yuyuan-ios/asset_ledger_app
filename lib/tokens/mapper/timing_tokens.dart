...
class TimingTokens {
  ...
  static const double recordTitleFontSize = 16; // 联系人·地址字号
  static const double recordTitleLineHeight = 1.1; // 联系人·地址行高
  static const double recordSubTitleTopGap = 6; // 主副标题间距
  static const double recordSubTitleFontSize = 15; // 副标题字号
  static const double recordValueLeftGap = 8; // 左右信息区间距
  static const double recordValueFontSize = 15; // 右侧数值字号
