...
class NavigationTokens {
  ...
  static const double itemRadius = 8; // 单个 Tab 点击区域的圆角半径
  ...
  static const double shadowBlur = 2; // 底部导航栏上方阴影的模糊半径
  static const double shadowOffsetY = -1; // 底部导航栏阴影在 Y 方向的偏移
  static const double shadowOpacity = 0.25; // 底部导航栏阴影透明度
