class SummaryCardTokens {
  // ===== 油电/维保页：统计卡共享排版 =====
  static const double cardRadius = 12; // 统计卡圆角（对齐计时卡片）
  static const double cardBorderWidth = 1; // 统计卡边框粗细（对齐计时卡片）
  static const double cardPadding = 24; // 统计卡内容内边距（油电/维保统一）
  static const double titleFontSize = 16; // 统计卡标题字号
  ...
  static const double totalLabelFontSize = 16; // 合计/年度总计标签字号
  static const double totalValueFontSize = 15; // 合计/年度总计数值字号
}
