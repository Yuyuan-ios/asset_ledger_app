...
class AccountTokens {
  ...
  static const int projectCardMergedSitesPreviewMaxChars = 8; // 合并项目地址预览字符数
  static const Color projectCardSingleRateBadgeBackground = Color(0xFFEAF2FA);
  static const Color projectCardSingleRateBadgeBorder = Color(0xFFD6E4EF);
  static const Color projectCardSingleRateBadgeText = Color(0xFF315A78);
