...
void main() {
  testWidgets(
    'shows net cash received and received label with unhighlighted amount',
    (tester) async {
      ...
      expect(find.text('净实收/已收'), findsOneWidget);
      expect(find.text('-¥2000'), findsOneWidget);

      final label = tester.widget<Text>(find.text('净实收/已收'));
