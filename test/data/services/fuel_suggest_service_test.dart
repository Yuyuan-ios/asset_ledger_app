...
void main() {
  group('FuelSuggestService.supplierCandidates', () {
    test(
      'extracts supplier history and removes blank or duplicate entries',
      () {
        final result = FuelSuggestService.supplierCandidates([
          FuelLog(
            id: 1,
            deviceId: 1,
            date: 20260301,
  ...
  group('FuelSuggestService.supplierSuggestions', () {
    test(
      'filters with prefix-first ordering through the shared suggest rules',
      () {
