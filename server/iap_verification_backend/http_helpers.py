...
LOGGER = logging.getLogger("fleet_ledger.iap_verification")
...
def log_iap_event(fields: Mapping[str, Any]) -> None:
    LOGGER.info("iap_event %s", json.dumps(fields, sort_keys=True, separators=(",", ":")))
