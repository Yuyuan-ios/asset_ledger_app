...
This project is indexed by GitNexus as **asset_ledger_app** (8408 symbols, 23698 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
