...
| Quality-first execution roadmap (dev@36d42f0) | `docs/quality/execution-roadmap-dev-36d42f0.md`, `docs/quality/codex-prompts-p0.md`, `docs/quality/codex-prompts-p1.md` |
