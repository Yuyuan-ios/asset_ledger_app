...
This project is indexed by GitNexus as **asset_ledger_app** (7633 symbols, 21396 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
